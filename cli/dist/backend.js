 ...
 */
export async function parsePackageInfo(filePath) {
    try {
 ...
 */
export async function discoverBackendModules() {
 ...
 */
export function resolveDependencies(moduleName, graph, scope = 'api') {
