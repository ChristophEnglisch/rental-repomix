...
import { buildBackendConfig, buildFrontendConfig, buildInfrastructureConfig, buildFullInfrastructureConfig } from './config-builder.js';
...
program
    ...
    .option('-l, --layers <layers>', 'Backend layers to include (domain,application,adapter)', (value) => value.split(','))
...
// Helper functions
// ============================================
function listAvailableModules(backend, frontend, infrastructure) {
